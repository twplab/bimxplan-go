  ...
  const createSampleProject = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase
        .from('projects')
        .insert({
          name: 'Sample BEP Project (Complete)',
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  <a href="/" className="flex items-center space-x-3 hover:opacity-90 transition-opacity">
                    ...
                    />
                    <h1 className="text-lg sm:text-xl font-bold text-gray-900">BIMxPlan Go</h1>
                  </a>
                </div>
              </div>
        ...
        <main className="flex-1 px-4 py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div className="flex-1">
              <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">Your Projects</h2>
